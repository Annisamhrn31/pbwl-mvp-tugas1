...
class Pelanggan extends Model
{
     ...
     public function save()
     {
          ...
          $sql = "INSERT INTO tb_pelanggan
            SET  pel_id_gol=:pel_id_gol, pel_no=:pel_no, pel_nama=:pel_nama, pel_ktp=:pel_ktp, pel_alamat=:pel_alamat, pel_hp=:pel_hp, pel_seri=:pel_seri, pel_meteran=:pel_meteran, pel_id_user=:pel_id_user";
     ...
     public function update()
     {
          ...
          $sql = "UPDATE tb_pelanggan
            SET  pel_id_gol=:pel_id_gol, pel_no=:pel_no, pel_nama=:pel_nama, pel_ktp=:pel_ktp, pel_alamat=:pel_alamat,
            pel_hp=:pel_hp, pel_seri=:pel_seri, pel_meteran=:pel_meteran, pel_id_user=:pel_id_user
           WHERE pel_id=:pel_id";
